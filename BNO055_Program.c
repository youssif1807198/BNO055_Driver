...
{
	/*THE FOLLOWING 3 LINES USED TO RESET BNO055 SENSOR BRFORE INTIALLIZING IT 
	YOU CAN USE ANY AVAILABLE GPIO PIN TO RESET SENSOR USING SOFTWARE 
	YOU CAN ALSO CHECK DATA SHEET FOR RESET SEQUENCE */
